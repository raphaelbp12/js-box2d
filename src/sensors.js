const sensors = {
    ...
    drawDebugger: null,
    // laserDegrees: [0],
    laserDegrees: [0, 1/8 * Math.PI, 2/8 * Math.PI, 3/8 * Math.PI, 4/8 * Math.PI, 5/8 * Math.PI, 6/8 * Math.PI, 7/8 * Math.PI, 8/8 * Math.PI, 9/8 * Math.PI, 10/8 * Math.PI, 11/8 * Math.PI, 12/8 * Math.PI, 13/8 * Math.PI, 14/8 * Math.PI, 15/8 * Math.PI],
    laserPoints: [],
    laserRadius: 5,
    laserImpactPoints: {},
    laserImpactDistances: {},
    carCenter: null,
    carOrientation: null,
    createSensors: function(world, scale, draw) {
        this.drawDebugger = draw
        this.world = world
        this.scale = scale
    },
    rayCallback: function(fixture, point, normalVector, fraction, payload){
    ...
    update: function(carCenter, carOrientation) {
